# Generated by Django 4.0.3 on 2023-01-01 16:41
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('kafedra', '0009_esp_kafedra_articles_image'),
    ]

    operations = [
        migrations.CreateModel(
            name='eng_kafedra_articles',
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='static/img/kafedra_photo/profe/', verbose_name='Фото')),
            ],
            options={
